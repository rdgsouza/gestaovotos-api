...
public class SpringDocConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Gestão de Votos API")
                        .version("v1")
                        .description("REST API da gestão de votos")
                        .license(new License()
                ...
                .tags(Arrays.asList(
                        ...
                        new Tag().name("Sessões").description("Gerencia as sessões"),
                        new Tag().name("Votos").description("Gerencia os votos"),
                        new Tag().name("Resultados").description("Gerencia os resultados")
