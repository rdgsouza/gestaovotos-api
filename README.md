...
não infrinja direitos de uso).
   ...
   Obs: Lembrando que inicialmente o banco de dados está sem dados para fazer testes. É preciso fazer um POST usando uma das URIs da aplicação para popular o banco de dados.
