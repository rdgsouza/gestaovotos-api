...
não infrinja direitos de uso).
   ...
   Configurei o nginx para receber as requisões pela porta 80 ou seja caso teste o projeto localmente pelo Docker, utilize a uri dessa forma Ex: <br>
   <a href="localhost:80/v1/pautas/1" alt="Api de Votação" target="_blank"> </a>

   Caso teste o projeto em produção que estar rodando no Docker, utilize a uri dessa forma. Ex: <br>
   <a href="20.195.202.49:80:80/v1/pautas/1" alt="Api de Votação" target="_blank"> </a>
